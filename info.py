...
PICS = (environ.get('PICS', 'https://i.ibb.co/RGfRT2jk/photo-2025-01-23-05-42-03-7530477859291267076.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/60e8a622b14796e4448ce.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/HpNcwvzR/photo-2025-05-06-15-41-18-7530474547871481880.jpg'))
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002471951904'))  # Notification of those who verify will be sent to your channel
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002471951904').split()]
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://PRE2:PRE2@cluster0.h3if9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
if HAS_SSL:
    URL = "https://youngest-sharline-chayadevi-f930aeff.koyeb.app/".format(FQDN)
else:
    URL = "https://youngest-sharline-chayadevi-f930aeff.koyeb.app/".format(FQDN)
